...
fun RecommendedInterCropScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.intercropping_plan), fontWeight = FontWeight.Bold) },
                navigationIcon = {
                ...
                actions = {
                    uiState.interCrop?.let {
                        RankDisplay(rank = it.rank, modifier = Modifier.padding(end = 16.dp))
                    }
                }
            )
        }
